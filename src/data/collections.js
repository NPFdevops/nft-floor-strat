...
const generateCollectionImage = (slug) => {
  ...
  const publicImages = {
    ...
    'cryptoadz': 'https://i.seadn.io/gae/iofetWVyOWfHNMNZNWcdOJa3yKHnmKGOTSNRDhz_2BKNHq__8KdLBjKrJrVOr8M1m8VuUBYdDOqJDjRcB8z7rqjOxfzP-NdVPKlZ?w=500&auto=format',
...
export const TOP_COLLECTIONS = [
  ...
  { slug: 'cryptoadz', name: 'CrypToadz by GREMPLIN', ranking: 50, image: generateCollectionImage('cryptoadz') },
